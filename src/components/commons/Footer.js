    ...
    return (
        <footer>
            ...
            <div className="footer-row">
                <p>Team of 4 led by Hoàng Nhật Thuận, mentored by Mrs. HuongNTC.</p>
                <p>Designed by Lê Nguyễn Bảo Toàn.</p>
                <p>Made with love and care for the Capstone Thesis of Fall 2021. No rights reserved.</p>
            </div>
        </footer>
    )
}
